...
namespace Home
{
    public class MyUICircularBuildingMenu : Singleton<MyUICircularBuildingMenu>
    {
        ...
        public class CircularButtonSettings
        {
            ...
            [SerializeField] EasyBuildSystem.Features.Runtime.Buildings.Part.BuildingPart m_BuildingPart;
            public EasyBuildSystem.Features.Runtime.Buildings.Part.BuildingPart BuildingPart { get { return m_BuildingPart; } set { m_BuildingPart = value; } }
        }
        ...
        public class CircularCategory
        {
            ...
            List<MyUICircularBuildingMenuButton> m_InstancedButtons = new List<MyUICircularBuildingMenuButton>();
            public List<MyUICircularBuildingMenuButton> InstancedButtons { get { return m_InstancedButtons; } set { m_InstancedButtons = value; } }
        ...
        [SerializeField] MyUICircularBuildingMenuButton m_UICircularButtonPrefab;
        ...
        void Update()
        {
            ...
            for (int i = 0; i < m_ButtonCount; i++)
            {
                MyUICircularBuildingMenuButton elementButton = m_CurrentCategory.InstancedButtons[i].GetComponent<MyUICircularBuildingMenuButton>();
            ...
            MyUICircularBuildingMenuButton selectedButton = m_SelectedButtonObject.GetComponent<MyUICircularBuildingMenuButton>();
                ...
                for (int i = 0; i < m_Categories.Count; i++)
                {
                    ...
                    if (m_Categories[i].ContentTransform != null)
                    {
                        ...
                        else if (gameObject.scene.IsValid())
                        {
                            ...
                            {
                                MyUICircularBuildingMenuButton buttonInstance = Instantiate(m_UICircularButtonPrefab, m_Categories[i].ContentTransform.transform);
