...
namespace HomeScripts.Editor
{
    ...
    public class MyUICircularBuildingMenuEditor : UnityEditor.Editor
    {
        ...
        MyUICircularBuildingMenu Target
        {
            get
            {
                return ((MyUICircularBuildingMenu)target);
            }
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUIUtilityExtension.DrawHeader("My UI Building Circular Menu",
            ...
            if (m_GeneralFoldout)
            {
                ...
                if ((MyUICircularBuildingMenu.PlatformTarget)serializedObject.FindProperty("m_PlatformTarget").enumValueIndex == MyUICircularBuildingMenu.PlatformTarget.STANDALONE)
                {
                ...
                else if ((MyUICircularBuildingMenu.PlatformTarget)serializedObject.FindProperty("m_PlatformTarget").enumValueIndex ==MyUICircularBuildingMenu.PlatformTarget.GAMEPAD)
                {
            ...
            if (m_CategoryFoldout)
            {
                ...
                for (int i = 0; i < serializedObject.FindProperty("m_Categories").arraySize; i++)
                {
                    ...
                    {
                        MyUICircularBuildingMenu.CircularCategory duplicateCateogry = Target.Categories[i];
                    ...
                    if (m_CategoriesFoldout[i])
                    {
                        ...
                        if (GUILayout.Button("Load Building Part Reference As Buttons..."))
                        {
                            for (int x = 0; x < BuildingManager.Instance.BuildingPartReferences.Count; x++)
                            {
                                ...
                                MyUICircularBuildingMenu.CircularButtonSettings instancedButton = new MyUICircularBuildingMenu.CircularButtonSettings()
                                {
                        ...
                        {
                            Target.Categories[i].Buttons = new List<MyUICircularBuildingMenu.CircularButtonSettings>();
                        }
                    }
                ...
                if (GUILayout.Button("Create Category..."))
                {
                    ...
                    Target.Categories.Add(new MyUICircularBuildingMenu.CircularCategory()
                    { 
                        Name = "New Category", 
